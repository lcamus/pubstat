...
***
<p style="text-align: right; font-size:90%; font-style: italic;">*`r ifelse(params$lang=="FR","Glissement annuel en pourcentage","Year-overyear percentage change")`*</p>
<p class="titlechart title">**`r ifelse(params$lang=="FR","Co&ucirc;t total horaire de la main-d'&oelig;uvre","Hourly labour cost")`** *(a)(b)*</p>
...
c1 <- highchart(width=450) %>%
  ...
  hc_tooltip(valueDecimals=1,shared=T,valueSuffix=" %", pointFormat=style.point.format) %>%
...
<p>&nbsp;</p>
<p class="titlechart">**Co&ucirc;t salarial horaire** *(b)*</p>
