...
htmltools::p(class="titlechart title",
             ifelse(params$lang=="FR","Co&ucirc;t total horaire de la main-d'&oelig;uvre","Hourly labour cost"),
             tags$sup("(a)(b)")
             )
```
...
```{r}
htmltools::p(class="titlechart title",
             ifelse(params$lang=="FR","Co&ucirc;t salarial horaire","Hourly wage cost"),
             tags$sup("(b)")
             )
```
