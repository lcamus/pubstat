...
sketch = htmltools::withTags(table(
  ...
  thead(
    ...
    tr(
      ...
      lapply(seq_along(t),function(x){th(names(t)[[x]],colspan=t[x],style="font-weight:bold;")})
    ),
    tr(
      lapply(col.q.q, th, style="font-weight:normal;")
    )
  )
))
rm(t)
...
# id <- paste0("dt-",htmlwidgets:::createWidgetId())
# t1 <- htmlwidgets::prependContent(
t1 <- DT::datatable(cbind(country=met[-1],sapply(data[-1,],as.numeric)),
  ...
  formatStyle(5, `border-left`='2px solid black')
