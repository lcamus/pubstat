...
#unique(data.y99.0[!is.na(data.y99.0$date),]$date)
# 
sketch = htmltools::withTags(table(
  thead(
    tr(
      th(colspan=1,rowspan=2),
      th(colspan=1,rowspan=1,ifelse(params$lang=="FR","année","year")),
      th(colspan=2,rowspan=1,ifelse(params$lang=="FR","année","year"),style=style.sep),
