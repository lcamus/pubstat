...
sketch = htmltools::withTags(table(
  thead(
    tr(
      ...
      th(colspan=ncol(data.y),rowspan=1,ifelse(params$lang=="FR","année","year"),style=sep.style),
      getTH(base::table(format(col.m,"%Y")),"Y",sep.style)
      # th(colspan=ncol(data.m)-1,rowspan=1)
    ),
    tr(
      # lapply(as.character(data.y[1,]), th, rowspan=2),
      getTH(base::table(col.y99),"Y",sep.style),
      getTH(base::table(col.y),"Y",sep.style),
